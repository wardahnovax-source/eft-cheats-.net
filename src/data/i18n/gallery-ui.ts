...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	en: {
		...
		lead: 'EFT Cheats helps you spot PMCs, Scavs, loot, and extracts with ESP, aimbot, and radar in one license.',
		highlights: [
	...
	es: {
		...
		lead: 'EFT Cheats está pensado para el loop BR de Escape from Tarkov: leer el mapa, rastrear escuadrones enemigos, lootear y sobrevivir al extract.',
		highlights: [
		...
		updatesLabel: 'Actualizaciones EFT Cheats',
		updatesShort: 'Updates',
	},
	fr: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats suit la boucle BR de Escape from Tarkov : lire la carte, suivre les escouades, loot et survivre au extract.',
		highlights: [
		...
		updatesLabel: 'Mises à jour EFT Cheats',
		updatesShort: 'Updates',
	},
	de: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats passt zur Raid-Schleife von Escape from Tarkov: Karte lesen, Gegner-Trupps tracken, looten und Extract überleben.',
		highlights: [
	...
	pt: {
		...
		lead: 'EFT Cheats segue o loop BR do Escape from Tarkov: ler o mapa, rastrear esquadrões, lootar e sobreviver ao extract.',
		highlights: [
		...
		updatesLabel: 'Atualizações EFT Cheats',
		updatesShort: 'Updates',
	},
	it: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats è pensato per il loop BR di Escape from Tarkov: leggere la mappa, tracciare squadre nemiche, loot e sopravvivere al extract.',
		highlights: [
		...
		updatesLabel: 'Aggiornamenti EFT Cheats',
		updatesShort: 'Updates',
	},
	nl: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats volgt de raid-loop van Escape from Tarkov: kaart lezen, vijandelijke squads volgen, looten en de extract overleven.',
		highlights: [
	...
	pl: {
		...
		lead: 'EFT Cheats pasuje do pętli BR Escape from Tarkov: czytaj mapę, śledź wrogie drużyny, lootuj i przeżyj extract.',
		highlights: [
		...
		updatesLabel: 'Aktualizacje EFT Cheats',
		updatesShort: 'Updates',
	},
	ru: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats создан для рейд-циклу Escape from Tarkov: читать карту, отслеживать вражеские отряды, лут и выживать в extract.',
		highlights: [
		...
		updatesLabel: 'Обновления EFT Cheats',
		updatesShort: 'Updates',
	},
	tr: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats, Escape from Tarkov BR döngüsü için: haritayı oku, düşman takımları izle, loot al ve extract\'da hayatta kal.',
		highlights: [
		...
		updatesLabel: 'EFT Cheats güncellemeleri',
		updatesShort: 'Updates',
	},
	ar: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats مبني لحلقة BR في Escape from Tarkov: قراءة الخريطة، تتبع الفرق، جمع اللوت والنجاة في extract.',
		highlights: [
		...
		updatesLabel: 'تحديثات EFT Cheats',
		updatesShort: 'Updates',
	},
	ja: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT CheatsはEscape from TarkovのBRループ向け：マップを読み、敵スクワッドを追跡し、ルートしてextractを生き延びる。',
		highlights: [
	...
	ko: {
		...
		lead: 'EFT Cheats는 Escape from Tarkov BR 루프용: 맵 읽기, 적 스쿼드 추적, 루트 수집, extract 생존.',
		highlights: [
	...
	zh: {
		...
		lead: 'EFT Cheats 为 Escape from Tarkov BR 循环设计：读图、追踪敌方小队、搜刮并在 extract 存活。',
		highlights: [
	...
	hi: {
		...
		lead: 'EFT Cheats Escape from Tarkov BR loop के लिए: map पढ़ें, enemy squads track करें, loot करें और extract survive करें।',
		highlights: [
	...
	id: {
		...
		lead: 'EFT Cheats untuk loop BR Escape from Tarkov: baca peta, lacak squad musuh, loot, dan selamat di extract.',
		highlights: [
		...
		updatesLabel: 'Update EFT Cheats',
		updatesShort: 'Updates',
	},
	th: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats สำหรับลูป BR ของ Escape from Tarkov: อ่านแผนที่ ติดตามทีมศัตรู เก็บ loot และรอด extract',
		highlights: [
		...
		updatesLabel: 'อัปเดต EFT Cheats',
		updatesShort: 'Updates',
	},
	vi: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats cho vòng BR Escape from Tarkov: đọc bản đồ, theo dõi squad địch, loot và sống sót extract.',
		highlights: [
		...
		updatesLabel: 'Cập nhật EFT Cheats',
		updatesShort: 'Updates',
	},
	uk: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats для рейд-циклу Escape from Tarkov: читати карту, відстежувати ворожі загони, лут і виживати в extract.',
		highlights: [
		...
		updatesLabel: 'Оновлення EFT Cheats',
		updatesShort: 'Updates',
	},
	cs: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats pro BR smyčku Escape from Tarkov: číst mapu, sledovat nepřátelské squady, loot a přežít extract.',
		highlights: [
		...
		updatesLabel: 'Aktualizace EFT Cheats',
		updatesShort: 'Updates',
	},
	ro: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats pentru bucla BR Escape from Tarkov: citește harta, urmărește squad-uri inamice, loot și supraviețuiește extract.',
		highlights: [
		...
		updatesLabel: 'Actualizări EFT Cheats',
		updatesShort: 'Updates',
	},
	sv: {
		eyebrow: 'EFT Cheats',
		...
		lead: 'EFT Cheats för Escape from Tarkov:s raid-loop: läs kartan, spåra fiendesquads, loota och överlev extract.',
		highlights: [
		...
		updatesLabel: 'EFT Cheats uppdateringar',
		updatesShort: 'Updates',
	},
};
