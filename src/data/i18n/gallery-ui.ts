...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	en: {
		eyebrow: 'eft cheats',
		title: 'eft cheats gallery',
		subtitle: 'Simple eft cheats visuals — ESP, wallhack, aimbot, and radar for Escape from Tarkov on PC.',
		lead: 'Escape from Tarkov helps you spot PMCs, Scavs, loot, and extracts with ESP, aimbot, and radar in one license.',
		highlights: [
			{ title: 'eft cheats esp', copy: 'See players through walls with eft cheats esp and wallhack overlays.' },
			{ title: 'eft cheats radar', copy: 'Track nearby threats with eft cheats radar before you push or extract.' },
			{ title: 'eft cheats aimbot', copy: 'Use soft aim and aimbot controls tuned for Tarkov raids on Windows PC.' },
		],
		updatesLabel: 'eft cheats updates',
	...
	es: {
		...
		lead: 'Escape from Tarkov está pensado para el loop BR de Escape from Tarkov: leer el mapa, rastrear escuadrones enemigos, lootear y sobrevivir al extract.',
		highlights: [
		...
		updatesLabel: 'Actualizaciones Escape from Tarkov',
		updatesShort: 'Updates',
	},
	fr: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov suit la boucle BR de Escape from Tarkov : lire la carte, suivre les escouades, loot et survivre au extract.',
		highlights: [
		...
		updatesLabel: 'Mises à jour Escape from Tarkov',
		updatesShort: 'Updates',
	},
	de: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov passt zur Raid-Schleife von Escape from Tarkov: Karte lesen, Gegner-Trupps tracken, looten und Extract überleben.',
		highlights: [
		...
		updatesLabel: 'Escape from Tarkov Updates',
		updatesShort: 'Updates',
	},
	pt: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov segue o loop BR do Escape from Tarkov: ler o mapa, rastrear esquadrões, lootar e sobreviver ao extract.',
		highlights: [
		...
		updatesLabel: 'Atualizações Escape from Tarkov',
		updatesShort: 'Updates',
	},
	it: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov è pensato per il loop BR di Escape from Tarkov: leggere la mappa, tracciare squadre nemiche, loot e sopravvivere al extract.',
		highlights: [
		...
		updatesLabel: 'Aggiornamenti Escape from Tarkov',
		updatesShort: 'Updates',
	},
	nl: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov volgt de raid-loop van Escape from Tarkov: kaart lezen, vijandelijke squads volgen, looten en de extract overleven.',
		highlights: [
	...
	pl: {
		...
		lead: 'Escape from Tarkov pasuje do pętli BR Escape from Tarkov: czytaj mapę, śledź wrogie drużyny, lootuj i przeżyj extract.',
		highlights: [
		...
		updatesLabel: 'Aktualizacje Escape from Tarkov',
		updatesShort: 'Updates',
	},
	ru: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov создан для рейд-циклу Escape from Tarkov: читать карту, отслеживать вражеские отряды, лут и выживать в extract.',
		highlights: [
		...
		updatesLabel: 'Обновления Escape from Tarkov',
		updatesShort: 'Updates',
	},
	tr: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov, Escape from Tarkov BR döngüsü için: haritayı oku, düşman takımları izle, loot al ve extract\'da hayatta kal.',
		highlights: [
		...
		updatesLabel: 'Escape from Tarkov güncellemeleri',
		updatesShort: 'Updates',
	},
	ar: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov مبني لحلقة BR في Escape from Tarkov: قراءة الخريطة، تتبع الفرق، جمع اللوت والنجاة في extract.',
		highlights: [
		...
		updatesLabel: 'تحديثات Escape from Tarkov',
		updatesShort: 'Updates',
	},
	ja: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from TarkovはEscape from TarkovのBRループ向け：マップを読み、敵スクワッドを追跡し、ルートしてextractを生き延びる。',
		highlights: [
		...
		updatesLabel: 'Escape from Tarkov更新',
		updatesShort: 'Updates',
	},
	ko: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov는 Escape from Tarkov BR 루프용: 맵 읽기, 적 스쿼드 추적, 루트 수집, extract 생존.',
		highlights: [
		...
		updatesLabel: 'Escape from Tarkov 업데이트',
		updatesShort: 'Updates',
	},
	zh: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov 为 Escape from Tarkov BR 循环设计：读图、追踪敌方小队、搜刮并在 extract 存活。',
		highlights: [
		...
		updatesLabel: 'Escape from Tarkov 更新',
		updatesShort: 'Updates',
	},
	hi: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov Escape from Tarkov BR loop के लिए: map पढ़ें, enemy squads track करें, loot करें और extract survive करें।',
		highlights: [
	...
	id: {
		...
		lead: 'Escape from Tarkov untuk loop BR Escape from Tarkov: baca peta, lacak squad musuh, loot, dan selamat di extract.',
		highlights: [
		...
		updatesLabel: 'Update Escape from Tarkov',
		updatesShort: 'Updates',
	},
	th: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov สำหรับลูป BR ของ Escape from Tarkov: อ่านแผนที่ ติดตามทีมศัตรู เก็บ loot และรอด extract',
		highlights: [
		...
		updatesLabel: 'อัปเดต Escape from Tarkov',
		updatesShort: 'Updates',
	},
	vi: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov cho vòng BR Escape from Tarkov: đọc bản đồ, theo dõi squad địch, loot và sống sót extract.',
		highlights: [
		...
		updatesLabel: 'Cập nhật Escape from Tarkov',
		updatesShort: 'Updates',
	},
	uk: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov для рейд-циклу Escape from Tarkov: читати карту, відстежувати ворожі загони, лут і виживати в extract.',
		highlights: [
		...
		updatesLabel: 'Оновлення Escape from Tarkov',
		updatesShort: 'Updates',
	},
	cs: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov pro BR smyčku Escape from Tarkov: číst mapu, sledovat nepřátelské squady, loot a přežít extract.',
		highlights: [
		...
		updatesLabel: 'Aktualizace Escape from Tarkov',
		updatesShort: 'Updates',
	},
	ro: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov pentru bucla BR Escape from Tarkov: citește harta, urmărește squad-uri inamice, loot și supraviețuiește extract.',
		highlights: [
		...
		updatesLabel: 'Actualizări Escape from Tarkov',
		updatesShort: 'Updates',
	},
	sv: {
		eyebrow: 'Escape from Tarkov',
		...
		lead: 'Escape from Tarkov för Escape from Tarkov:s raid-loop: läs kartan, spåra fiendesquads, loota och överlev extract.',
		highlights: [
		...
		updatesLabel: 'Escape from Tarkov uppdateringar',
		updatesShort: 'Updates',
	},
};
