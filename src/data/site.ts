...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_EFT',
		rating: 5,
		text: 'Soft aim in Escape from Tarkov feels smooth on Customs. The menu took a few minutes to learn. After that, raids felt easy.',
		short: 'Soft aim in Escape from Tarkov feels smooth on Customs.',
	...
	reviewMeta({
		handle: 'buildsR4K',
		rating: 4,
		text: 'ESP boxes help on Scav runs. You can see who is holding a hallway before you push. Still worth the price for Escape from Tarkov.',
		short: 'ESP boxes help on Scav runs. Still worth the price for Escape from Tarkov.',
	...
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to Escape from Tarkov this wipe. Setup was simple. It stayed up after the last BattlEye update when my old cheat failed. Lifetime was a good buy.',
		short: 'Escape from Tarkov stayed up after the last BattlEye update. Lifetime was a good buy.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in Escape from Tarkov is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in Escape from Tarkov is easy to tune on PC.',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Escape from Tarkov works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Woods is solid.',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in Escape from Tarkov pays for the monthly plan. Extract markers and distance make early raids faster.',
		short: 'Loot ESP in Escape from Tarkov pays for the monthly plan.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'I have used Escape from Tarkov since last wipe. Soft aim per weapon helps in dorms. Status updates after BattlEye patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in Escape from Tarkov helps in dorms.',
	...
	reviewMeta({
		handle: 'vanLifeEFT',
		rating: 5,
		text: 'Radar in Escape from Tarkov saved me near extracts. Seeing the third party early in duos is huge. Boxes plus radar look clean.',
		short: 'Radar in Escape from Tarkov saved me near extracts.',
	...
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. Escape from Tarkov posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'Escape from Tarkov was back the next morning after a patch.',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Bolt-action soft aim plus ESP in Escape from Tarkov is excellent for long shots. Simple and strong.',
		short: 'Bolt-action soft aim plus ESP in Escape from Tarkov is excellent.',
