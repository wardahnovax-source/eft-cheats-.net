...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_EFT',
		rating: 5,
		text: 'Soft aim in EFT Cheats feels smooth on Customs. The menu took a few minutes to learn. After that, raids felt easy.',
		short: 'Soft aim in EFT Cheats feels smooth on Customs.',
	...
	reviewMeta({
		handle: 'buildsR4K',
		rating: 4,
		text: 'ESP boxes help on Scav runs. You can see who is holding a hallway before you push. Still worth the price for EFT Cheats.',
		short: 'ESP boxes help on Scav runs. Still worth the price for EFT Cheats.',
	...
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to EFT Cheats this wipe. Setup was simple. It stayed up after the last BattlEye update when my old cheat failed. Lifetime was a good buy.',
		short: 'EFT Cheats stayed up after the last BattlEye update. Lifetime was a good buy.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in EFT Cheats is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in EFT Cheats is easy to tune on PC.',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'EFT Cheats works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Woods is solid.',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in EFT Cheats pays for the monthly plan. Extract markers and distance make early raids faster.',
		short: 'Loot ESP in EFT Cheats pays for the monthly plan.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'I have used EFT Cheats since last wipe. Soft aim per weapon helps in dorms. Status updates after BattlEye patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in EFT Cheats helps in dorms.',
	...
	reviewMeta({
		handle: 'vanLifeEFT',
		rating: 5,
		text: 'Radar in EFT Cheats saved me near extracts. Seeing the third party early in duos is huge. Boxes plus radar look clean.',
		short: 'Radar in EFT Cheats saved me near extracts.',
	...
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. EFT Cheats posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'EFT Cheats was back the next morning after a patch.',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Bolt-action soft aim plus ESP in EFT Cheats is excellent for long shots. Simple and strong.',
		short: 'Bolt-action soft aim plus ESP in EFT Cheats is excellent.',
