 ...
 * Canonical site: https://eftcheats.net (matches brand.url)
 *
 * Requires DNS: CNAME `www` → `eftcheats.net` (proxied) AND
 * Workers custom domain `www.eftcheats.net` attached — otherwise
...
const CANONICAL_HOST = 'eftcheats.net';
